...
class Transaction extends Model
{
    ...
    protected $fillable = ['type','vcard','date','datetime','value','old_balance','new_balance','payment_reference','payment_type','pair_vcard','pair_transaction','category_id','description'];
