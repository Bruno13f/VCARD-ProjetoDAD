    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="mb-3 me-3 flex-grow-1">
        ...
        <select
          ...
          id="inputResponsible"
          v-model="editingVcard.responsible_id"
        >
    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="mb-3 me-3 flex-grow-1">
        ...
        <input
          ...
          v-model="editingVcard.preview_start_date"
        >
      </div>
      ...
      <div class="mb-3 ms-xs-3 flex-grow-1">
        ...
        <input
          ...
          v-model="editingVcard.preview_end_date"
        >
      </div>
    </div>
    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="mb-3 me-3 flex-grow-1">
        ...
        <input
          ...
          v-model="editingVcard.real_start_date"
        >
      </div>
      ...
      <div class="mb-3 ms-xs-3 flex-grow-1">
        ...
        <input
          ...
          v-model="editingVcard.real_end_date"
        >
      </div>
    </div>
